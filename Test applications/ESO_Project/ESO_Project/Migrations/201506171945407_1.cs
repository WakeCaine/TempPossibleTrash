namespace ESO_Project.Migrations
{
    ...
    public partial class _1 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.String(nullable: false, maxLength: 128),
                        ActiveFlag = c.Int(nullable: false),
                ...
                c => new
                    {
                        ...
                        vector = c.Binary(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AspNetUsers", t => t.userId, cascadeDelete: true)
                .Index(t => t.userId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.KeysVectors", "userId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Files", "FolderId", "dbo.Folders");
            DropForeignKey("dbo.Folders", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropIndex("dbo.Subscriptions", new[] { "UserId" });
            DropIndex("dbo.KeysVectors", new[] { "userId" });
